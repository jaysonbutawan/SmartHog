...
class FarmSummaryService {
  ...
  Future<FarmSummaryResponse> getFarms() async {
    try {
      // 📝 FIX: Changed absolute URL to relative path
      final res = await _dio.get('/api/v1/farms-summary');
      ...
      print('🔐 Headers: ${e.requestOptions.headers}'); // 👈 Check your terminal for this!
      print('------------------');
